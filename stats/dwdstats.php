<?php
	...
	$token		=	"net.downwithdestruction.dwdStats";
	$allowed_ip	=	array('127.0.0.1','5.9.78.163');
	...
	$db_host	=	"localhost";
	$db_user	=	"mindcrack";
	$db_pass	=	"CCz2CdhMbjWTnB7B";
	$db_name	=	"mindcrack_wwwLag";
...
*/
	...
	if (($_GET['token'] == $token) && (in_array($_SERVER['REMOTE_ADDR'],$allowed_ip)))
		{
